    ...
    $.ajax({
        ...
        success: function(result){
            ...
            $.each(result, function (i, data){
                ...
                html += '<a href=' + data.id +'"../Usuario/editar_receita.html?id= "><img src="../view/img/rubber.svg"  alt=""></a>';
                html += '<a href=' + data.id +'"../Usuario/view_receita.html?id= "><img src="../view/img/eye.svg"  alt=""></a></td></tr>';
